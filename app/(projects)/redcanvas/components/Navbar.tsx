...
export default function Navbar() {
  ...
  return (
    <>
      <nav className="h-16 flex-shrink-0 bg-[#0a0a0a]/80 backdrop-blur-xl border-b border-white/[0.06] px-6 flex items-center justify-between z-50">
        ...
        {/* Mobile Menu Button */}
        <button 
          className="md:hidden p-2 rounded-md hover:bg-white/[0.06] transition-colors"
      ...
      <div 
        className={`fixed inset-0 bg-[#0a0a0a] z-40 md:hidden transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        <div className="p-6 flex flex-col gap-6">
          <Link
            href="/"
            className="text-lg font-medium text-white/60 hover:text-red-400 transition-colors py-2"
            onClick={() => setIsMenuOpen(false)}
          >
            主页
          </Link>
